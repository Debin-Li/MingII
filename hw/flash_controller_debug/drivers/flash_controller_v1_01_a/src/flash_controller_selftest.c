/*****************************************************************************
* Filename:          C:\EDK\flash_controller_debug/drivers/flash_controller_v1_01_a/src/flash_controller_selftest.c
* Version:           1.01.a
* Description:       Contains a diagnostic self-test function for the flash_controller driver
...
#define FLASH_CONTROLLER_SELFTEST_BUFSIZE  512 /* Size of buffer (for transfer test) in bytes */

/************************** Variable Definitions ****************************/

static Xuint8 __attribute__((aligned (128))) SrcBuffer[FLASH_CONTROLLER_SELFTEST_BUFSIZE];   /* Source buffer      */
static Xuint8 __attribute__((aligned (128))) DstBuffer[FLASH_CONTROLLER_SELFTEST_BUFSIZE];   /* Destination buffer */
...
XStatus FLASH_CONTROLLER_SelfTest(void * baseaddr_p)
{
  ...
  FLASH_CONTROLLER_mReset(baseaddr);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg0(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg1(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg2(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg3(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg4(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg5(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg6(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg7(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg8(baseaddr, 0, 9);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg8(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg9(baseaddr, 0, 10);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg9(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg10(baseaddr, 0, 11);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg10(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg11(baseaddr, 0, 12);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg11(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg12(baseaddr, 0, 13);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg12(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg13(baseaddr, 0, 14);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg13(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg14(baseaddr, 0, 15);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg14(baseaddr, 0);
  ...
  FLASH_CONTROLLER_mWriteSlaveReg15(baseaddr, 0, 16);
  Reg32Value = FLASH_CONTROLLER_mReadSlaveReg15(baseaddr, 0);
  ...
  for ( Index = 0; Index < FLASH_CONTROLLER_SELFTEST_BUFSIZE; Index++ )
  {
    SrcBuffer[Index] = Index;
    DstBuffer[Index] = 0;
  }
  xil_printf("   - start user logic master module to receive bytes from the source\n\r");
  FLASH_CONTROLLER_MasterRecvByte(baseaddr, (Xuint32) SrcBuffer, FLASH_CONTROLLER_SELFTEST_BUFSIZE);
  while ( ! FLASH_CONTROLLER_mMasterDone(baseaddr) ) {}
  xil_printf("   - transfer completed\n\r");
  xil_printf("   - start user logic master module to send bytes to the destination\n\r");
  FLASH_CONTROLLER_MasterSendByte(baseaddr, (Xuint32) DstBuffer, FLASH_CONTROLLER_SELFTEST_BUFSIZE);
  while ( ! FLASH_CONTROLLER_mMasterDone(baseaddr) ) {}
  xil_printf("   - transfer completed\n\r");
  for ( Index = 0; Index < FLASH_CONTROLLER_SELFTEST_BUFSIZE; Index++ )
  {
  ...
  Reg32Value = FLASH_CONTROLLER_mReadReg(baseaddr, FLASH_CONTROLLER_INTR_IPISR_OFFSET);
  xil_printf("   - IP (user logic) interrupt status : 0x%08x\n\r", Reg32Value);
  xil_printf("   - clear IP (user logic) interrupt status register\n\r");
  FLASH_CONTROLLER_mWriteReg(baseaddr, FLASH_CONTROLLER_INTR_IPISR_OFFSET, Reg32Value);
  Reg32Value = FLASH_CONTROLLER_mReadReg(baseaddr, FLASH_CONTROLLER_INTR_DISR_OFFSET);
  xil_printf("   - Device (peripheral) interrupt status : 0x%08x\n\r", Reg32Value);
  xil_printf("   - clear Device (peripheral) interrupt status register\n\r");
  FLASH_CONTROLLER_mWriteReg(baseaddr, FLASH_CONTROLLER_INTR_DISR_OFFSET, Reg32Value);
  xil_printf("   - enable all possible interrupt(s)\n\r");
  FLASH_CONTROLLER_EnableInterrupt(baseaddr_p);
