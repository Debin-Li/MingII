...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\svn-local\trunk\hw\XUPv5\xupv5
  logical library name                       : usr_access_v1_00_a
  top name                                   : usr_access
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/usr_access_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/usr_access_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/usr_access_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	C:\svn-local\trunk\hw\XUPv5\xupv5\C:\Xilinx\13.4\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
